        ...
        <div className="flex flex-col items-center text-center font-mono px-4 py-10">
          ...
          <div className="mt-10 w-full flex flex-col lg:flex-row items-center justify-center gap-10 px-6">
            ...
            <div className="p-8 flex flex-col items-start max-w-md w-full">
              <div className="text-2xl font-bold mb-2 text-text-primary-light"> ChatterBox – End-to-End Encrypted Real-Time Chat App</div>
          ...
          <div className="mt-10 w-full flex flex-col lg:flex-row-reverse items-center justify-center gap-10 px-6">
            {/* Text Card */}
            <div className="p-8 flex flex-col items-start max-w-md w-full">
              <div className="text-2xl font-bold mb-2 text-text-primary-light">EventEase – Serverless Ticketing & RSVP Web Portal</div>
              <div className="text-sm text-text-secondary-light text-start">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsa,
                eius debitis ad officia dolorum nobis aperiam sit nostrum.
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsa,
          ...
          <div className="mt-10 w-full flex flex-col lg:flex-row items-center justify-center gap-10 px-6">
            {/* Text Card */}
            <div className="p-8 flex flex-col items-start max-w-md w-full">
              <div className="text-2xl font-bold mb-2 text-text-primary-light"> BlogBurst – Scalable Multi-Tenant Blogging Platform</div>
              <div className="text-sm text-text-secondary-light text-start">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsa,
                eius debitis ad officia dolorum nobis aperiam sit nostrum.
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsa,
