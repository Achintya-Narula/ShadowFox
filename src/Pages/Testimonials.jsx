  ...
  const testimonials = [
    {
      ...
      name: "Caleb Osei – CEO, AtlasForge Media",
    },
    {
      img: "/images/client2.png",
      text: "Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      name: "Mateo Alvarez – CTO, HorizonPeak Ventures",
    },
    {
      img: "/images/client3.png",
      text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      name: "Priya Nandakumar – Product Manager, Skylark Innovations",
    },
    {
      img: "/images/client4.png",
      text: "Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      name: "Sofia Rizzo – VP of Engineering, NovaPulse Solutions",
    },
  ];
